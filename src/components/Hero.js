...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col md:flex-row px-4 py-0 bg-black items-center justify-between overflow-hidden min-h-screen">
      {/* Text Content */}
      <div className="w-full md:w-1/2 flex flex-col text-center md:text-left">
        ...
        <div className="flex justify-center z-5 md:justify-start  py-10 px-2">
          <a
            ...
            className="text-white pr-3  transition-transform duration-500 ease-in-out
 hover:scale-150
"
          >
...
0"
      ...
      {/* Hero Image Overlay */}
      <div className="absolute right-0 bottom-6 md:relative md:w-1/3 px-0 md:px-10 z-0 opacity-20 md:opacity-100 md:self-end">
        <img
          src={Heroimg}
          alt="Hero section illustration"
          className="w-full max-w-[420px] md:max-w-none object-contain scale-110 md:scale-125 transition-transform duration-500 ease-in-out hover:scale-150"
        />
      </div>
    </section>
  );
